...
original_bipartite = pd.read_table("networks/bipartite/1_2.gr", header=None)
...
for prop in range(10,80,10):
    ...
    new_bip.to_csv("networks/bipartite/1_2_prop"+str(prop)+".gr", sep="\t", index=False, header=True)