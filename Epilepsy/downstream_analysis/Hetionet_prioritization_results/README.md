The file ```epilepsy_case_study_top100.txt``` was downloaded from the Repethio github project: [https://github.com/dhimmel/rephetio](https://github.com/dhimmel/rephetio/blob/gh-pages/epilepsy/data/PK-curation.tsv)
